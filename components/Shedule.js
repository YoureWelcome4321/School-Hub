...
export default function Schedule() {
  ...
  const replacement = useState(true);
      ...
      <View style={{ flex: 1 }} {...panResponder.panHandlers}>
        ...
        >
              ...
              return (
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.dayNumber,
                      isCurrent && styles.dayTextActive,
                    ]}
                  >
                    {formatNumber(date)}
                  </Text>
          ...
          {loading ? (
            ...
            <>
              <Image
                source={require("../assets/noshedule.png")}
                style={{
                  width: 170,
                  height: 170,
                  alignSelf: "center",
              ...
              <Text style={styles.noData}>
                Расписание на этот день отсутствует, отдыхайте
              </Text>
            </>
          )}
        </ScrollView>
